...
const HintChip: FC = () => {
  return (
    <div className="absolute top-4 right-4 text-sm text-gray-800 bg-white border border-gray-300 px-3 py-1 rounded shadow-md pointer-events-none select-none">
